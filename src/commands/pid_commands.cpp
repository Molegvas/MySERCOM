...
// 0x4? Команда смены режима cmd_pid_mode
// в массивах настройки есть все данные для конфигурирования пид-регулятора
// но это наверное команда управления процессом...
